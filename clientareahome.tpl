...
<div class="ho-stat-tiles">
    <div class="row">
        <div class="col-sm-3 col-xs-6 ho-stat-col">
            <div class="ho-stat-tile ho-stat-tile-blue" onclick="window.location='clientarea.php?action=services'">
        ...
        {if $clientsstats.numdomains || $registerdomainenabled || $transferdomainenabled}
            <div class="col-sm-3 col-xs-6 ho-stat-col">
                <div class="ho-stat-tile ho-stat-tile-green" onclick="window.location='clientarea.php?action=domains'">
        ...
        {elseif $condlinks.affiliates && $clientsstats.isAffiliate}
            <div class="col-sm-3 col-xs-6 ho-stat-col">
                <div class="ho-stat-tile ho-stat-tile-green" onclick="window.location='affiliates.php'">
        ...
        {else}
            <div class="col-sm-3 col-xs-6 ho-stat-col">
                <div class="ho-stat-tile ho-stat-tile-green" onclick="window.location='clientarea.php?action=quotes'">
        ...
        {/if}
        <div class="col-sm-3 col-xs-6 ho-stat-col">
            <div class="ho-stat-tile ho-stat-tile-purple" onclick="window.location='supporttickets.php'">
        ...
        <div class="col-sm-3 col-xs-6 ho-stat-col">
            <div class="ho-stat-tile ho-stat-tile-red" onclick="window.location='clientarea.php?action=invoices'">
