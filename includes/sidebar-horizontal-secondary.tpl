{*
    Horizontal counterpart to includes/sidebar.tpl for secondary sidebar
    (e.g. Categories/Actions on store pages, sidebar panels on other pages).

    Renders the same $secondarySidebar panel objects as a row of
